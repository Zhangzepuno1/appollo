...
#ifndef MODULES_PREDICTION_EVALUATOR_VEHICLE_DNN_EVALUATOR_H_
#define MODULES_PREDICTION_EVALUATOR_VEHICLE_DNN_EVALUATOR_H_
...
class DNNEvaluator : public Evaluator {
 public:
  /**
   * @brief Constructor
   */
...
#endif  // MODULES_PREDICTION_EVALUATOR_VEHICLE_DNN_EVALUATOR_H_
